...
const products: MarketplaceProduct[] = [
  {
    ...
    description: "A comprehensive video course covering all aspects of applying to elite universities, including personal statement writing, interview preparation, and admissions tests.",
    price: 500,
  ...
  {
    id: "course-2",
    title: "Oxford Interview Mastery",
    description: "Learn how to excel in Oxford interviews with real practice questions, mock interviews, and expert feedback.",
    price: 350,
    image: "/headshots/placeholder.jpg",
    category: "course",
    rating: 4.8,
  ...
  {
    id: "resource-1",
    title: "Personal Statement Template Bundle",
    description: "A collection of 50+ successful personal statements for various courses at top universities with annotations and analysis.",
    price: 200,
    image: "/headshots/placeholder.jpg",
    category: "resource",
    rating: 4.7,
  ...
  {
    id: "course-3",
    title: "Cambridge STEM Application Masterclass",
    description: "Specialized guidance for STEM applications to Cambridge, including subject-specific preparation and test strategies.",
    price: 450,
    image: "/headshots/placeholder.jpg",
    category: "course",
    rating: 4.9,
    reviewCount: 96,
    instructor: "Dr. Emily Robertson",
    duration: "10 hours",
    level: "advanced"
  },
  {
    id: "resource-2",
    title: "Comprehensive Admission Test Bundle",
    description: "Practice papers, worked solutions, and strategies for all major university admission tests including BMAT, LNAT, TSA, and MAT.",
    price: 250,
    image: "/headshots/placeholder.jpg",
    category: "resource",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Interactive templates to create outstanding academic CVs for university applications and scholarships.",
    price: 150,
    image: "/headshots/placeholder.jpg",
    category: "template",
    rating: 4.6,
  ...
  {
    id: "consultation-1",
    title: "One-on-One Application Review",
    description: "A comprehensive review of your entire university application with personalized feedback from a university admissions expert.",
    price: 600,
    image: "/headshots/placeholder.jpg",
  ...
  {
    id: "course-4",
    title: "US College Admissions Strategy",
    description: "Complete guide to applying to top US universities, including SAT/ACT preparation, essays, and extracurricular activities.",
    price: 550,
    image: "/headshots/placeholder.jpg",
    category: "course",
    rating: 4.7,
    reviewCount: 89,
    instructor: "Jessica Matthews",
    duration: "14 hours",
    level: "all",
    new: true
  }
