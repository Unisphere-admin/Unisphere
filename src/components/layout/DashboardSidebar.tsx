...
const DashboardSidebar = () => {
  ...
  const navItems = [
    ...
    ...(!isStudent ? [
      {
        ...
        active: pathname === "/dashboard/students" || pathname?.startsWith("/dashboard/students/"),
      },
    ] : []),
    {
      title: "Timeline",
    ...
    },
    {
      ...
      active: pathname === "/dashboard/deadlines",
    },
    {
      title: "Sessions",
      icon: <Calendar className="h-5 w-5" />,
      href: "/dashboard/schedule",
      active: pathname === "/dashboard/schedule" || pathname === "/dashboard/history",
    },
    ...(isStudent ? [
      {
        title: "Find a Tutor",
    ...
    <div className="h-full flex flex-col py-6">
      ...
      <div className="px-6 mb-6">
        <Link href="/">
          <div className="flex items-center gap-3 px-2">
            <Image src="/logo-name.png" alt="Unisphere" height={32} width={200} className="h-8 w-auto" priority />
          </div>
        </Link>
      </div>
      ...
      <div className="px-4 py-2">
        <Link href="/dashboard/profile" className="block">
          <div className="rounded-xl border border-border/60 bg-card/40 backdrop-blur-sm shadow-sm overflow-hidden hover:bg-card/60 hover:border-[#128ca0]/30 hover:shadow-md transition-all duration-200 cursor-pointer">
