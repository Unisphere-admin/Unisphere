        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tutors" className="text-muted-foreground hover:text-foreground">Find Tutors</Link>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Become a Tutor</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Mathematics</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Science</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Languages</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Humanities</a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-foreground">Computer Science</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">info@tutormatch.com</span>
              </div>
            </div>
          </div>
        </div>
